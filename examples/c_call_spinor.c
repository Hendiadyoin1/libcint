...
int cint1e_spnucsp(complex_t *buf, int *shls,
                   int *atm, int natm, int *bas, int nbas, double *env);

int cint2e_spsp1(complex_t *buf, int *shls,
                 int *atm, int natm, int *bas, int nbas, double *env,
                 CINTOpt *opt);
...
int main()
{
        ...
        buf = malloc(sizeof(complex_t) * di * dj);
        ...
        buf = malloc(sizeof(complex_t) * di * dj * dk * dl);
